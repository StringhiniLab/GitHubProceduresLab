...
![](img/create_repository.png){width=70%}{fig-alt: }
...
There is more material available on organizing project structures @ubclibrary, using `.gitignore` @theturingwayKeepingSensitive or other resources listed [here](https://book.the-turing-way.org/project-design/sdpw/pd-sdp-resources), or creating good README files (The Turing Way - [Readme File](https://book.the-turing-way.org/project-design/project-repo/project-repo-readme)) and name conventions @ubclibrary if you want to explore further.
