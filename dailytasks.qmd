...
- Software Carpentry Lessons [@scarpentry]

- Happy Git and GitHub for the useR book [@bryan_happy_git]

- Setting up a GitHub Repository for Your Lab - Version Control and Code Management with GitHub [@codingclub]

- The book Data Science: A First Introduction [@datasciencebookcollaboration]

- The Turing Way Handbook [@turing] and the Code Refinery Lessons [@coderefinery_lessons]
