...
| Store the code associated with scientific publications publicly in a GitHub repository | The benefits of leaving code [open source](https://book.the-turing-way.org/reproducible-research/open.html) [@turing, @bertram2023]. | This section will be developed at the time of the first paper's publication |
...
There is public material covering how and why to create a lab manual [@Aly2018; @tendler2023; @turing]. If you're looking for a practical example that incorporates code management, check out @compgeolab_manual.
